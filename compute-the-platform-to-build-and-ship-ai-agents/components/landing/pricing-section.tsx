...
const plans = [
  {
    name: "Free tier",
    description: "Start with source-code context",
  ...
  {
    name: "$20 tier",
    description: "Plan and generate infrastructure",
  ...
  {
    name: "Custom tier",
    description: "Operate approved deployments",
    price: { monthly: null, annual: null },
    features: [
      "AWS runtime deployment",
      "Endpoint verification",
      "Runtime details",
      "Stop and destroy controls",
      "DeplAI-managed resources",
      "Operational workspace",
      "Settings and documentation",
      "Provider-assisted workflows",
    ],
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20">
          <div className="lg:col-span-7">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
              ...
              From source
              <br />
              <span className="text-stroke">to runtime.</span>
            </h2>
          </div>
