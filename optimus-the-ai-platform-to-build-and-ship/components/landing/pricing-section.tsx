...
const plans = [
  ...
  {
    name: "Growth",
    description: "For growing businesses and platforms",
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="max-w-3xl mb-20">
          ...
          <p className="text-lg text-muted-foreground max-w-xl">
            Start at $0, grow at $49, or work with us on an enterprise deployment. No hidden fees, no surprises.
          </p>
        </div>
