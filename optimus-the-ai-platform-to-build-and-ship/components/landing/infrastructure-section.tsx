...
Cloud & bare-metal deployment
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-12">
              Deploy securely to AWS, GCP, Azure, Heroku, or bare-metal infrastructure. DeplAI adapts the architecture to your requirements and leaves you with complete platform ownership.
            </p>
