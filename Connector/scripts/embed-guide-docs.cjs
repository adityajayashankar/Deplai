...
export const GUIDE_GROUPS: Array<{ id: GuideGroupId; label: string; slugs: string[] }> = [
  { id: 'start', label: 'Start here', slugs: ['introduction', 'concepts', 'how-it-works', 'getting-started'] },
  { id: 'services', label: 'Services', slugs: ['security-agent', 'deploy', 'uiux-customizer', 'code-reviewer', 'sessions'] },
  { id: 'account', label: 'Account', slugs: ['security-and-data', 'billing'] },
