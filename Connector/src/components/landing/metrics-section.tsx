...
const metrics = [
  { 
    ...
    suffix: "", 
    prefix: "",
    label: "Connected delivery stages",
    sublabel: "repository to runtime",
  },
  { 
    value: 1,
    suffix: "",
    prefix: "",
    label: "Repository control surface",
    sublabel: "GitHub + local",
  },
  { 
    value: 1,
    suffix: "",
    prefix: "",
    label: "Runtime deployment lane",
    sublabel: "AWS-first",
  },
];
    ...
    <section ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20 lg:mb-32">
          <div className="lg:col-span-8 lg:col-start-1">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[140px] font-display tracking-tight leading-[0.95] transition-all duration-1000 ${
              ...
              One connected
              <br />
              <span className="text-muted-foreground">delivery workflow.</span>
            </h2>
          </div>
        </div>
        ...
        <div className={`mt-16 pt-8 border-t border-foreground/10 flex flex-wrap items-center gap-x-12 gap-y-4 text-sm font-mono text-muted-foreground transition-all duration-1000 delay-500 ${
          ...
          <span>Terraform bundles</span>
          <span>AWS runtime</span>
          <span>Docker workflows</span>
          <span className="text-foreground">provider-assisted planning</span>
        </div>
      </div>
    </section>
  );
