...
export function IntegrationsSection() {
  ...
  return (
    <section id="integrations" ref={sectionRef} className="relative overflow-hidden">
      ...
      {/* Header â€” centrÃ© verticalement sur l'image */}
      <div className="relative z-10 pt-32 lg:pt-40 text-center">
        ...
        <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
          ...
          Connect the
          <br />
          <span className="text-muted-foreground">delivery stack.</span>
        </h2>

        <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg mx-auto transition-all duration-1000 delay-100 ${
          isVisible ? "opacity-100" : "opacity-0"
        }`}>
          DeplAI connects GitHub repositories and local projects to Terraform generation, AWS runtime operations, and AI-assisted engineering workflows. GitLab and Bitbucket support is coming soon.
        </p>
      </div>
      ...
      {/* Integration grid â€” remonte sur l'image avec spacing mobile appropriÃ© */}
