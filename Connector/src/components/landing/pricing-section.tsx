...
const plans = [
  {
    name: "Free tier",
    description: "Start with core security workflows",
    price: 0,
    features: [
      "GitHub connection",
  ...
  {
    name: "Plus tier",
    description: "Complete the delivery workflow",
    price: 50,
    features: [
      "GitHub + local connections; GitLab/Bitbucket on release",
      "Security analysis — SAST, DAST + SCA",
      "Complete remediation with advanced models to PR",
      "Unlimited customization with advanced models",
      "Full access to deployment",
    ],
    cta: "Open workspace",
    highlight: true,
  },
  {
    name: "Pro tier",
    description: "Scale with your engineering team",
    price: 120,
    features: [
      "5× Plus usage",
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20">
          <div className="lg:col-span-7">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
              ...
              From source
              <br />
              <span className="landing-text-stroke">to runtime.</span>
            </h2>
          </div>
