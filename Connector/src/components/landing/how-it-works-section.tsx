...
const steps = [
  {
    ...
    description: "Connect a GitHub project or local files and establish the codebase context DeplAI needs for analysis and delivery planning.",
    code: `repository.connect({
  provider: 'github',
  ...
  },
  {
    ...
    title: "Analyze",
    subtitle: "and plan",
    description: "Review security signals and answer guided architecture questions to create a deployment profile.",
    code: `deployment.plan({
  security: 'analyze',
  architecture: 'guided-review',
  output: 'deployment-profile'
})`,
  },
  {
    number: "03",
    title: "Review",
    subtitle: "then deploy",
    description: "Approve remediation and infrastructure changes before generating Terraform and moving into AWS runtime operations.",
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/30">Review.</span>
              <span className="block text-white/10">Deploy.</span>
            </h2>
          </div>

          {/* Image cerisier â€” se colle en bas sur les blocs */}
