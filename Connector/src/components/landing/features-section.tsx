...
const features = [
  {
    ...
    description: "Customize your frontend without affecting your project's business logic, so your product can evolve safely and quickly.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Agentic Automation",
    description: "AI agents turn user requirements and project demands into clear, automated actions across your delivery workflow.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Cybersecurity",
    description: "Scan your project for vulnerabilities and let our agents help fix them before they become production risks.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Deployment Intelligence",
    description: "Analyze dependencies, gather traffic requirements, estimate costs, generate Terraform efficiently, and deploy through your cloud console with full ownership.",
    visual: "security",
  },
];
