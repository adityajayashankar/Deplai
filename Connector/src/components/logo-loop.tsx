...
const useResizeObserver = (
  ...
  }, [callback, containerRef, sequenceRef, logos, gap, logoHeight, isVertical]);
};
  ...
  ({
    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: React.Key) => {
        ...
        const logoItem: NodeLogoItem | ImageLogoItem = item;
        ...
        const content = isNodeItem ? (
          <span
            ...
            aria-hidden={!!logoItem.href && !(logoItem as NodeLogoItem).ariaLabel}
          >
            {(logoItem as NodeLogoItem).node}
          </span>
        ) : (
          <img
            className={cx(
            ...
            src={(logoItem as ImageLogoItem).src}
            srcSet={(logoItem as ImageLogoItem).srcSet}
            sizes={(logoItem as ImageLogoItem).sizes}
            width={(logoItem as ImageLogoItem).width}
            height={(logoItem as ImageLogoItem).height}
            alt={(logoItem as ImageLogoItem).alt ?? ''}
            title={(logoItem as ImageLogoItem).title}
            loading="lazy"
            decoding="async"
            draggable={false}
          />
        ...
        const itemAriaLabel = isNodeItem
          ? ((logoItem as NodeLogoItem).ariaLabel ?? (logoItem as NodeLogoItem).title)
          : ((logoItem as ImageLogoItem).alt ?? (logoItem as ImageLogoItem).title);
        ...
        const inner = logoItem.href ? (
          <a
            ...
            onClick={(e) => {
              e.preventDefault();
              const newWindow = window.open(logoItem.href, '_blank', 'noopener,noreferrer');
              newWindow?.focus();
            }}
          >
            {content}
