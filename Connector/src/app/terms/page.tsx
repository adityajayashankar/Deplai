...
export default function TermsPage() {
  return (
    <div className="deplai-auth min-h-screen bg-background">
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        <Link href="/" className="inline-flex mb-8 hover:opacity-80 transition-opacity">
          <DeplaiLogo size={28} wordmarkClassName="font-semibold text-lg text-foreground" />
        </Link>
        <Link
          href="/auth/signup"
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-6 text-muted-foreground">
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              <a href="mailto:founders@deplai.tech" className="text-foreground underline underline-offset-4 hover:text-primary">
                founders@deplai.tech
              </a>
            </p>
          </section>
        </div>
