...
PARAM_SCHEMA: dict[str, list[dict]] = {
    ...
    "rds": [
        ...
        {"name": "storage_type", "type": "string", "default": "gp3"},
        ...
        {"name": "storage_autoscaling", "type": "bool", "default": True},
        {"name": "max_allocated_storage", "type": "number", "default": 0},
        {"name": "aurora_replica_count", "type": "number", "default": 0},
        {"name": "aurora_cluster_storage_type", "type": "string", "default": "standard"},
        {"name": "backup_retention_period", "type": "number", "default": 7},
        {"name": "aurora_min_acu", "type": "number", "default": 0.5},
        {"name": "aurora_max_acu", "type": "number", "default": 4.0},
    ],
    "vpc": [
